...
data = [
    ...
    Row(owner=f"{current_user}", object=None, key="warehouse_name", value="shared_warehouse"),
    ...
    Row(owner="account users", object=None, key="datasets.Databricks_Simulated_Retail_Customer_Data", value="Databricks_Simulated_Retail_Customer_Data.v01"),
    Row(owner="account users", object=None, key="paths.datasets.Databricks_Simulated_Retail_Customer_Data", value="/Volumes/Databricks_Simulated_Retail_Customer_Data/v01"),
