...
data = [
    ...
    Row(owner="account users", object=None, key="datasets.arxiv_sample_articles", value="dbacademy_arxiv_sample_articles.v01"),
    Row(owner="account users", object=None, key="paths.datasets.arxiv_sample_articles", value="/Volumes/dbacademy_arxiv_sample_articles/v01"),
