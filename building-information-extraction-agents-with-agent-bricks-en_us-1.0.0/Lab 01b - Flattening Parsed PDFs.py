...
# Display the table 01_single_pdf_parsed
df = <FILL_IN >

# Create a table named 02_pdf_parsed_flattened with the following columns:
# source_doc, page_number, element_id, element_type, content
spark.sql(<FILL_IN>)
