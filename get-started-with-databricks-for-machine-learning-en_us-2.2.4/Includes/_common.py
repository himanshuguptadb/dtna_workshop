...
# MAGIC %pip install -U databricks-sdk==0.36.0 databricks-feature-engineering
...
data = [
    ...
    Row(owner="account users", object=None, key="datasets.wine_quality", value="databricks_wine_quality_data.v01"),
    Row(owner="account users", object=None, key="paths.datasets.wine_quality", value="/Volumes/databricks_wine_quality_data/v01"),
    Row(owner="account users", object=None, key="datasets.airbnb", value="dbacademy_airbnb.v01"),
    Row(owner="account users", object=None, key="paths.datasets.airbnb", value="/Volumes/databricks_airbnb/v01"),
